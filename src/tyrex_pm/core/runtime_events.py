"""Internal runtime event payloads (legacy EventBus sketch).

Moved from ``core/events.py`` in M2B.0-A to make room for the Phase 2B
:class:`~tyrex_pm.core.events.MarketEvent` contract. Not used by live trading
paths today; preserved for potential future ``EventBus`` wiring.
"""
