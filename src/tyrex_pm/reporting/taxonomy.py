...
_REASON_TO_DELTA: dict[str, str] = {
    ...
    ReasonCode.RISK_HEALTH_UNKNOWN_BOOTSTRAP: "tradable_state_health",
    ReasonCode.RISK_HEALTH_DEGRADED_OMS: "tradable_state_health",
    ReasonCode.RISK_HEALTH_DIVERGENT_PERSISTENT: "tradable_state_health",
    ReasonCode.STARTUP_NOT_READY: "startup_readiness",
    ReasonCode.STARTUP_TERMINAL_NOT_READY: "startup_readiness",
    ReasonCode.STARTUP_DEGRADED_NO_BUY: "startup_readiness",
    ReasonCode.STARTUP_DEGRADED_HEALTH_MISSING: "startup_readiness",
    ReasonCode.SHUTDOWN_DRAIN_ACTIVE: "shutdown_drain",
