...
FACT_TYPE_Z_GAP_ENTRY_PLAN = "z_gap_entry_plan"
FACT_TYPE_Z_GAP_ENTRY_BLOCKED = "z_gap_entry_blocked"
FACT_TYPE_Z_GAP_ENTRY_REJECTED = "z_gap_entry_rejected"
FACT_TYPE_Z_GAP_ENTRY_PARTIAL_FILL = "z_gap_entry_partial_fill"
FACT_TYPE_Z_GAP_ENTRY_EXECUTION_UNRESOLVED = "z_gap_entry_execution_unresolved"
FACT_TYPE_Z_GAP_PTB_SOURCE_SELECTED = "z_gap_ptb_source_selected"
FACT_TYPE_Z_GAP_PTB_SOURCE_MISMATCH = "z_gap_ptb_source_mismatch"
FACT_TYPE_Z_GAP_PTB_LOCKED = "z_gap_ptb_locked"
FACT_TYPE_Z_GAP_ENTRY_SUBMIT_READY = "z_gap_entry_submit_ready"
FACT_TYPE_Z_GAP_ENTRY_SUBMITTED = "z_gap_entry_submitted"
FACT_TYPE_Z_GAP_ENTRY_FILL = "z_gap_entry_fill"
FACT_TYPE_Z_GAP_ENTRY_UNFILLED = "z_gap_entry_unfilled"
FACT_TYPE_Z_GAP_POSITION_ACTIVATED = "z_gap_position_activated"
FACT_TYPE_MODEL_EXIT_TRIGGERED = "model_exit_triggered"
FACT_TYPE_Z_GAP_EXIT_SUBMITTED = "z_gap_exit_submitted"
FACT_TYPE_Z_GAP_EXIT_FILL = "z_gap_exit_fill"
FACT_TYPE_Z_GAP_EXIT_UNFILLED = "z_gap_exit_unfilled"
FACT_TYPE_Z_GAP_EXIT_ATTEMPT = "z_gap_exit_attempt"
FACT_TYPE_Z_GAP_POSITION_CLOSED = "z_gap_position_closed"
FACT_TYPE_Z_GAP_LIFECYCLE_STATE = "z_gap_lifecycle_state"
FACT_TYPE_Z_GAP_MANUAL_INTERVENTION_REQUIRED = "z_gap_manual_intervention_required"
FACT_TYPE_Z_GAP_POSITION_RECONCILIATION = "z_gap_position_reconciliation"
FACT_TYPE_Z_GAP_RECONCILIATION_WARNING = "z_gap_reconciliation_warning"
FACT_TYPE_Z_GAP_RECONCILIATION_FAILED = "z_gap_reconciliation_failed"
...
FACT_TYPE_Z_GAP_WINDOW_SKIPPED_INSUFFICIENT_PRESTART = "z_gap_window_skipped_insufficient_prestart"
FACT_TYPE_Z_GAP_STARTUP_TIMING = "z_gap_startup_timing"
FACT_TYPE_Z_GAP_SESSION_STATUS = "z_gap_session_status"
FACT_TYPE_Z_GAP_RUNTIME_STARTED = "z_gap_runtime_started"
FACT_TYPE_Z_GAP_PTB_CAPTURE = "z_gap_ptb_capture"
FACT_TYPE_Z_GAP_SIGMA_WARMUP = "z_gap_sigma_warmup"
FACT_TYPE_MODEL_NUMERIC_ANOMALY = "model_numeric_anomaly"
