    ...
    *,
    ...
    def section(name: str, cls: type) -> Any:
        ...
        for f in dataclasses.fields(cls):
            ...
            kwargs[f.name] = _coerce_field(defaults, f.name, sec_raw[f.name], path=path, file=file)
...
def zgap_config_to_parameters_dict(cfg: ZGapConfig) -> dict[str, Any]:
    ...
    return {
        "volatility": {
            ...
            "sigma_floor": cfg.volatility.sigma_floor,
        },
        "entry": {
        ...
        "time_resolution": {
            ...
            "resolution_capability_default": (cfg.time_resolution.resolution_capability_default),
