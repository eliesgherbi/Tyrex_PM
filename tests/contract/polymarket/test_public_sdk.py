...
from tyrex_pm.market_data.book_health import FeedSyncPhase
...
def test_sdk_book_event_and_multi_price_change_and_size_zero() -> None:
    ...
    pc = SimpleNamespace(
        ...
        payload=SimpleNamespace(
            timestamp=TS,
            price_changes=(
                SimpleNamespace(token_id=UP, side="BUY", price=Decimal("0.5"), size=Decimal("0")),
                SimpleNamespace(token_id=UP, side="SELL", price=Decimal("0.61"), size=Decimal("2")),
            ),
        ),
    )
